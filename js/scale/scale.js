...
export class Scale{
  ...
  // 周波数計算
	// static getFrequency(KeyIndex /* 何番目の鍵か */){
	// 	const semitoneSpan = this.#scalePattern[KeyIndex];
	// 	if(semitoneSpan === undefined)return null;
	// 	const totalOffset = this.#rootOffset + semitoneSpan;	// A4からの半音差
	// 	return this.#A4 * (2 ** (totalOffset / 12));
	// }
